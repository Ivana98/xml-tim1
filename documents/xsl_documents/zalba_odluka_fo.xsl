...
<xsl:stylesheet 
    ...
    xmlns:ns2="http://www.ftn.uns.ac.rs/zalba-na-odluku"
            ...
            <fo:page-sequence master-reference="zalba-na-odluku-page">
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:block font-family="Times New Roman" width="60%"
                        ...
                        <fo:inline>
                            <xsl:value-of select="/ns2:zalba_na_odluku/ns2:zalba/ns2:zalilac/ns2:ime"></xsl:value-of>
                        </fo:inline>
                        ,
                        <fo:inline>
                            <xsl:value-of select="/ns2:zalba_na_odluku/ns2:zalba/ns2:zalilac/ns2:prezime"></xsl:value-of>
                        </fo:inline>
                        ,
                        <fo:inline>
                            <xsl:value-of select="/ns2:zalba_na_odluku/ns2:zalba/ns2:zalilac/ns2:adresa/ns2:grad"></xsl:value-of>
                        </fo:inline>
                        ,
                        <fo:inline>
                            <xsl:value-of select="/ns2:zalba_na_odluku/ns2:zalba/ns2:zalilac/ns2:adresa/ns2:ulica"></xsl:value-of> 
                        </fo:inline>
                        ,
                        <fo:inline>
                            <xsl:value-of select="/ns2:zalba_na_odluku/ns2:zalba/ns2:zalilac/ns2:adresa/ns2:broj"></xsl:value-of>
                        </fo:inline>
                        ,
                        <fo:inline>
                            <xsl:value-of select="/ns2:zalba_na_odluku/ns2:zalba/ns2:zalilac/ns2:sediste"></xsl:value-of>
                        </fo:inline>
                    </fo:block>
                    <fo:block font-family="Times New Roman" font-size="11pt" text-align="center" font-weight="bold">
                    ...
                    <fo:block font-family="Times New Roman" width="60%"
                        margin-top="11pt" text-align="center" border-bottom-style="dotted">
                        ( <xsl:value-of select="/ns2:zalba_na_odluku/ns2:zalba/ns2:naziv_organa"></xsl:value-of> )
                    </fo:block>
                    <fo:block font-family="Times New Roman" font-size="11pt"
                    ...
                    <fo:block font-family="Times New Roman" font-size="11pt"
                        ...
                        Број
                        <fo:inline>
                            <xsl:value-of select="/ns2:zalba_na_odluku/ns2:zalba/ns2:broj_zahteva"></xsl:value-of>
                        </fo:inline>
                        од 
                        <fo:inline>
                            <xsl:value-of select="/ns2:zalba_na_odluku/ns2:zalba/ns2:godina"></xsl:value-of>
                        </fo:inline>
                        године. 
                    </fo:block>
                    
                    <fo:block font-family="Times New Roman" font-size="11pt"
                        text-align="justify" margin-top="10pt" text-indent="40px">
                        ...
                        <fo:inline border-bottom-style="dotted">
                            <xsl:value-of select="/ns2:zalba_na_odluku/ns2:zalba/ns2:sadrzaj/ns2:datum"></xsl:value-of>
                        </fo:inline>
                        ...
                        <fo:inline border-bottom-style="dotted">
                            <xsl:value-of select="/ns2:zalba_na_odluku/ns2:zalba/ns2:sadrzaj/ns2:deo_odluke"></xsl:value-of>
                        </fo:inline>
                    ...
                    <fo:block font-family="Times New Roman" font-size="11pt" text-align="right" margin-top="10pt" margin-bottom="-7pt">
                        <xsl:value-of select="/ns2:zalba_na_odluku/ns2:zalba/ns2:podnosilac/ns2:ime"></xsl:value-of>
                        <xsl:value-of select="/ns2:zalba_na_odluku/ns2:zalba/ns2:podnosilac/ns2:prezime"></xsl:value-of>
                    </fo:block>
                    ...
                    <fo:block font-family="Times New Roman" font-size="11pt" text-align="right" margin-top="3pt"  margin-bottom="-7pt">
                        <xsl:value-of select="/ns2:zalba_na_odluku/ns2:zalba/ns2:podnosilac/ns2:adresa/ns2:grad"></xsl:value-of>
                        <xsl:value-of select="/ns2:zalba_na_odluku/ns2:zalba/ns2:podnosilac/ns2:adresa/ns2:ulica"></xsl:value-of>
                        <xsl:value-of select="/ns2:zalba_na_odluku/ns2:zalba/ns2:podnosilac/ns2:adresa/ns2:broj"></xsl:value-of>
                    </fo:block>
                    ...
                    <fo:block font-family="Times New Roman" font-size="11pt" text-align="right" margin-top="3pt"  margin-bottom="-7pt">
                        <xsl:value-of select="/ns2:zalba_na_odluku/ns2:zalba/ns2:podnosilac/ns2:kontakt_podaci"></xsl:value-of> 
                    </fo:block>
                    <fo:block font-family="Times New Roman" font-size="11pt" text-align="right" >
                        <fo:block font-size="11pt" text-align="right">.........................................................................</fo:block>
                    ...
                    <fo:block text-align="left" margin-top="10pt" font-family="Times New Roman" font-size="11pt">
                        У 
                        <fo:inline  border-bottom-style="dotted">
                            <xsl:value-of select="/ns2:zalba_na_odluku/ns2:zalba/ns2:vreme_i_mesto/ns2:grad"></xsl:value-of>
                        </fo:inline>
                        , дана 
                        <fo:inline border-bottom-style="dotted">
                            <xsl:value-of select="/ns2:zalba_na_odluku/ns2:zalba/ns2:vreme_i_mesto/ns2:datum"></xsl:value-of>
                        </fo:inline> године.
                    </fo:block>
