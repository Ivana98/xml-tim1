 ...
 * generated in the tim1.backend.test package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: tim1.backend.test
     * 
     */
    ...
    public JAXBElement<Select> createZalbaNaCutanjeSadrzajRazloziZalbe(Select value) {
        return new JAXBElement<Select>(_ZalbaNaCutanjeSadrzajRazloziZalbe_QNAME, Select.class, ZalbaNaCutanje.Sadrzaj.class, value);
    }
    ...
    public JAXBElement<XMLGregorianCalendar> createZalbaNaCutanjeSadrzajDatumPodnosenjaZahteva(XMLGregorianCalendar value) {
        return new JAXBElement<XMLGregorianCalendar>(_ZalbaNaCutanjeSadrzajDatumPodnosenjaZahteva_QNAME, XMLGregorianCalendar.class, ZalbaNaCutanje.Sadrzaj.class, value);
    }
