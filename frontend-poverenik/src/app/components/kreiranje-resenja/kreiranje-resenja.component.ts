...
<Resenje_obrazac xmlns="http://www.ftn.uns.ac.rs/resenje"
    ...
    <Datum property="pred:datumResenja" datatype="xs:date">2020-06-09</Datum>
    <Uvod>
    ...
    <Sadrzaj>
        ...
        <Obrazlozenje>
            ...
            <Sadrzaj_obrazlozenja>
                ...
                Такође је увидом у списе предмета утврђено да по захтеву жалиоца од 16.04.2020. године, орган власти није поступио, што је био дужан да учини без одлагања, а најкасније у року од 15 дана од пријема захтева те да жалиоца, у смислу члана 16. став 1. Закона о слободном приступу информацијама од јавног значаја, обавести да ли поседује тражене информације и да му, уколико исте поседује, стави на увид документ који исте садржи односно изда му или достави копију документа у коме су тражене информације садржане, или да у супротном донесе решење о одбијању захтева, у смислу става 10. истог члана.
                Имајући у виду да орган власти по захтеву жалиоца од 16.04.2020. године није поступио у складу са наведеним одредбама Закона о слободном приступу информацијама од јавног значаја, а да није оправдао разлоге непоступања по поднетом захтеву, Повереник је у поступку по жалби, на основу члана 23. и члана 24. ст. 1. и 4. Закона о слободном приступу информацијама од јавног значаја и члана 173. ст. 2. Закона о општем управном поступку, одлучио као у ставу I диспозитива овог решења, нашавши да је жалба основана, односно да је неспорно право жалиоца на тражене информације у смислу члана 5. Закона о слободном приступу информацијама од јавног значаја, по коме свако има право да му буде саопштено да ли орган власти поседује или му је доступна одређена информација од јавног значаја, као и да му се информација, уколико је у поседу органа, учини доступном, на начин како је то наложено у ставу I диспозитива овог решења, што је у складу са одредбом члана 12. Закона о слободном приступу информацијама од јавног значаја, која предвиђа могућност издвајања тражене информације од јавног значаја од осталих информација садржаних у документу у које орган власти није дужан да тражиоцу омогући увид, јер би се доступношћу тим информацијама повредило право на приватност и заштиту података о личности лица на која се тражене информације односе.
                Учитељски факултет у Призрену са привременим седиштем у Лепосавићу, је дужан да о извршењу решења из става I диспозитива, обавести Повереника у складу са чланом 24. став 3. Закона о слободном приступу информацијама од јавног значаја.
                Упутство о правном средству:
                Против овог решења није допуштена жалба већ се, у складу са Законом о управним споровима, може покренути управни спор тужбом Управном суду у Београду, у року од 30 дана од дана пријема решења. Такса на тужбу износи <Cena>390.00</Cena> динара.
            </Sadrzaj_obrazlozenja>
        </Obrazlozenje>
    </Sadrzaj>
    <Poverenik about="http://www.ftn.uns.ac.rs/rdf/resenje/Poverenik">
        <Ime property="pred:ime" datatype="xs:string">Милан</Ime>
        <Prezime property="pred:prezime" datatype="xs:string">Мариновић</Prezime>
    </Poverenik>
</Resenje_obrazac>
    `;
